...
<head>
    ...
    <link rel="stylesheet" href=" {{asset('crypto-figma/style.css')}}">
...
<section class="section3">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-xs-12">
            <div class="card3 ">
                <img class="mobile" src="{{ ('crypto-figma/images/mobile.png') }}" alt="">
        ...
        <div class="col-md-3 col-xs-12">
            <div class="card3">
                <img class="arrow" src="{{ ('crypto-figma/images/arrow.png') }}" alt="">
        ...
        <div class="col-md-3 col-xs-12">
            <div class="card3">
                <img class="doller" src="{{ ('crypto-figma/images/doller.png') }}" alt="">
    ...
    <div class="dotline1">
    <img src="{{ ('crypto-figma/images/dotlinepng.png') }}" alt="">
    </div>
    <div class="dotline2">
    <img src="{{ ('crypto-figma/images/dotlinepng.png') }}" alt="">
    </div>
