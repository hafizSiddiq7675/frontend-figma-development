...
<body>
            ...
            <header class="top-menu">
                <nav class="navbar navbar-expand-lg navbar-light ">
                    <div class="container-fluid">
                        ...
                        <button style="margin-right:20px" class="navbar-toggler" type="button"
                        ...
                        <div class="section-left">
                            <div class="icon">
                                <div class="question-mark"> <img
                                        src="{{ asset('images/Question.png') }}images/Question.png" alt="">
                                </div>
                                <div class="heart-mark"> <img src="{{ asset('images/heart.png') }}" alt="">
                                </div>
                                <div class="search-mark"><img src="{{ asset('images/search.png') }}" alt="">
                                </div>
                            ...
                            <div>
                                <div><img class="main-img" src="{{ asset('images/Group 349.png') }}" alt="">
                                </div>
                                        ...
                                        <div id="carouselExampleControls" class="carousel" data-bs-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="carousel-item1 active">
                                                    <div class="card1">
                                                        <img class="img2"
                                                            src="{{ 'images/unsplash_8WC3ibi7MTg.png' }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="carousel-item1">
                                                    <div class="card1">
                                                        <img class="img2"
                                                            src="{{ 'images/unsplash_B0G8xzwTVWc.png' }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="carousel-item1">
                                            ...
                                            <button class="carousel-control-prev" type="button"
                                                ...
                                                <span class="slide-left" aria-hidden="true"><img class="first-image"
                                                        src="{{ asset('images/left-arrow.png') }}"
                                                        alt="previous button" /></span>
                                                <span class="visually-hidden">Previous</span>
                                            </button>
                                            <button class="carousel-control-next" type="button"
                                                data-bs-target="#carouselExampleControls" data-bs-slide="next">
                                                <span class="slide-right" aria-hidden="true"><img
                                                        class="second-image"
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                    <div class="info-1">
                        <div class="images"><img src="{{ asset('images/fireEmoji.png') }}" alt=""
                                class="info1">
                            <div>
                                <p class="heading">Safe Shopping</p>
                            </div>
                            <div>
    ...
    <div class="container main2">
        ...
        <p class="trending-paragraph">Lorem ipsum dolor sit amet. Ut molestiae esse ad dignissimos vitae ea sunt
            consequatur et autem .</p>
    </div>
                    ...
                    <div id="carouselExampleControls" class="carousel" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="card">
                                    <div class="img-wrapper"><img src="{{ asset('images/shoes1.png') }}"
                                            class="d-block w-100" alt="Blue Sneakers"> </div>
                                    <div class="card-body">
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="{{ asset('images/shoes2.png') }}"
                                            class="d-block w-100" alt="Nike Air "> </div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <div>
                                                <div>Nike Air</div>
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="{{ asset('images/shoes3.png') }}"
                                            class="d-block w-100" alt="Nike Max"> </div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <div>
                                                <div>Nike Max</div>
                            ...
                            <div class="carousel-item">
                                <div class="card">
                                    <div class="img-wrapper"><img src="{{ asset('images/shoes4.png') }}"
                                            class="d-block w-100" alt="Gym Wear "> </div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <div>
                                                <div>Gym wear</div>
                        ...
                        <button class="carousel-control-prev" type="button"
                            data-bs-target="#carouselExampleControls" data-bs-slide="prev">
                            <span class="slide-left" aria-hidden="true"><img
                                    src="{{ asset('images/left-arrow.png') }}" alt="previous button" /></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button"
                            data-bs-target="#carouselExampleControls" data-bs-slide="next">
                            <span class="slide-right" aria-hidden="true"><img
                                    src="{{ asset('images/right-arrow.png') }}" alt="previous button" /></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                    </div>
            ...
            <div class="row">
                <div class=" section4-main-div col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class=" section4-left-div">
                        ...
                        <div>
                            <p class="inner-title-section4-left">Big Sale</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    ...
                    <div class="part">
                        <div class="part-top">
                            <div class="girl-image"><img src="{{ asset('images/girl-imagepng.png') }}"
                                    alt=""></div>
    ...
    <footer>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="links">
                        <div><img class="facebook" src="{{ asset('images/facebooklogo.png') }}" alt="">
                        </div>
                        <div><img class="instagram" src="{{ asset('images/instagramlogo.png') }}" alt="">
                        </div>
